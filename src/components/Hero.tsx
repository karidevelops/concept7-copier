  ...
  return <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="text-center animate-fade-in">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-primary-foreground mb-6 animate-scale-in tracking-tight drop-shadow-[0_4px_8px_rgba(0,0,0,0.8)]">
            Kasvu, kannattavuus<br />
            ja arjen ratkaisut.
          </h1>
          <p className="text-xl md:text-2xl text-primary-foreground/90 mb-10 max-w-3xl mx-auto leading-relaxed font-bold drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">Sparraan niin pieniä startupeja kuin kasvuvaiheessa olevia pk-yrityksiä. Kirkastetaan tarjooma, tuotteistetaan, optimoidaan kustannukset ja rakennetaan hinnoittelu, joka kestää kasvun. Olen tukenasi myös yrityksen arkisissa haasteissa. Toimin myös interim-johtajana ja hallitusjäsenenä kasvuvaiheen yrityksissä.</p>
